...
public class CreateAccountManager {
    ...
    private static Logger logger = Logger.getLogger(CreateAccountManager.class);
    //media type
     ...
     */
    public Request Get(CreateAccountParams params) throws HttpRequest.HttpRequestException {
