 ...
 * Time: 下午3:28
 */
public class DeleteConManager {

    private static Logger logger = Logger.getLogger(DeleteConManager.class);
    //media type
    ...
    public Request Delete(DeleteConParams params) throws HttpRequest.HttpRequestException {
