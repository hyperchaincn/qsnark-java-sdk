 ...
 * Time: 下午2:12
 */
public class DeployConManager {


    private static Logger logger = Logger.getLogger(DeployConManager.class);
    //media type
    ...
    public String sourceURL = BaseConfig.URL.getType() + "/v1/dev/contract/deploy";
