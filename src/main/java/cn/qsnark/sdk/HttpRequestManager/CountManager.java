...
public class CountManager {
    ...
    private static Logger logger = Logger.getLogger(CountManager.class);
    //media type
    ...
    public String sourceURL = BaseConfig.URL.getType() + "/v1/dev/transaction/count?";
     ...
     */
    public Request Get(String params) throws HttpRequest.HttpRequestException {
