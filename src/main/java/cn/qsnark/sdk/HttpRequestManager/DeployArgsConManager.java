...
import cn.qsnark.sdk.rpc.params.DeployArgsConParams;
 ...
 * Time: 下午2:12
 */
public class DeployArgsConManager {


    private static Logger logger = Logger.getLogger(DeployArgsConManager.class);
    //media type
    ...
    public String sourceURL = BaseConfig.URL.getType() + "/v1/dev/contract/deployargs";


    public String SyncRequest(DeployArgsConParams params) throws IOException {
    ...
    public Request Post(DeployArgsConParams params) throws HttpRequest.HttpRequestException {
