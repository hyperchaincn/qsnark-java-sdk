...
//        invokeContract();
    ...
    public static void invokesyncContract() throws Exception {
        ...
        FuncParamReal param1 = new FuncParamReal("uint32", 1);
        FuncParamReal param2 = new FuncParamReal("uint32", 2);
        GetTxReciptReturn getTxReciptReturn = api.invokesyncContract("Bearer _CC9XQTUNMQGOMKDX0Y0QA", true,"0x7c2b111bce226cde5848a6304dc36922b7099491"
                , "0x83665f52cd2d201269da2faa6c877d2d037b991b", abi, "getAddress");
