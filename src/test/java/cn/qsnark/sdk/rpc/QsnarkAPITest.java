...
public class QsnarkAPITest {
    ...
    public void getAccess_Token() throws Exception {
        ...
        GetTokenReturn getTokenReturn = api.getAccess_Token("123", "123", "15858172775", "123");
    ...
    public void createAccount() throws Exception {
        ...
        CreteAccountReturn creteAccountReturn = api.createAccount("Bearer 6ANMC5Z8O_IER-5A0KYMRA");
    ...
    public void queryBlock() throws Exception {
        ...
        QueryBlockReturn queryBlockReturn = api.queryBlock("Bearer 1MHCDLJGOP28FDWBWISKCA", "number", "latest");
...
//        String s = "";
//        s = null;
        CompileReturn compileReturn = api.compileContract("Bearer 1MHCDLJGOP28FDWBWISKCA", s);
